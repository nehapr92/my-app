        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-sm">
                BaidyanathDham Darshan is dedicated to providing seamless pooja
                services for devotees visiting the sacred temple. Experience
